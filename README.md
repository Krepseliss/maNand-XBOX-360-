...
<p align="center">
  <em style="color:red;"><strong></bolt></B>Currently only 16MB nands are support. 256MB or 4GB nands will not get the correct classification and the result will be misleading. DO NOT RISK IT</strong></em>
</p>
